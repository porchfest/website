...
var createTemplate = function(feature) {
    ...
    bandTemplate += '<p class="show-description">'+feature.properties.performer__1_description+'</p>';
    ...
    bandTemplate += '<p class="show-description">'+feature.properties.performer__2_description+'</p>';
    ...
    bandTemplate += '<p class="show-description">'+feature.properties.performer__3_description+'</p>';
    ...
    bandTemplate += '<p class="show-description">'+feature.properties.performer__4_description+'</p>';
...
$(document).ready(function() {
    ...
    var resizeHeroImage = function() {
        var sizeHeroText = $heroText.height() + 9;
